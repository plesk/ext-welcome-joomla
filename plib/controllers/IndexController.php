...
class IndexController extends pm_Controller_Action
{
    ...
    {
        $step = Modules_WelcomeJoomla_Helper::getNextStep();
        pm_Settings::set('welcome-step', $step);

        $this->redirect(Modules_WelcomeJoomla_Helper::getReturnUrl());
    }
    ...
    public function installAction()
    {
        if (!empty($_GET['extension'])) {
            ...
            $result = Modules_WelcomeJoomla_Helper::installExtension($extension);
